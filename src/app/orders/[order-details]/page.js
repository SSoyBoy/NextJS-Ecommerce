    ...
    <div className="py-14 px-4 md:px-6">
      <div className="flex justify-start items-start space-y-2 flex-col">
        <div className="w-full">
          <h1 className="text-3xl lg:text-4xl font-bold leading-7 lg:leading-9 text-gray-900 overflow-hidden">
          ...
          <div className="flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:p-6 xl:p-8 w-full">
            ...
            orderDetails.orderItems.length
              ? orderDetails.orderItems.map((item) => (
                  <div
                    key={item._id}
                    className="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-start items-start sm:items-center sm:space-x-6 xl:space-x-8 w-full"
                  >
                    <div className="pb-4 md:pb-8 w-full sm:w-40">
                      <img
                        src={item && item.product && item.product.imageUrl}
                        className="w-full max-h-52 sm:h-20 flex object-cover rounded-lg"
                      />
                    </div>
                    <div className="border-b border-gray-300 sm:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 sm:space-y-0">
