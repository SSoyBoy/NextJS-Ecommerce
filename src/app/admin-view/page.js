                  ...
                  {allOrdersForAllUsers.map((item) => (
                    ...
                    >
                      <div className="flex flex-col md:flex-row">
                        <h1 className="font-bold text-lg mb-3 flex-1 truncate">
                          #order: {item._id}
                        </h1>
                      ...
                      <div className="flex gap-5 max-[415px]:flex-col">
                        <button className="disabled:opacity-50 mt-5 mr-5 max-[415px]:mr-0  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide">
                          {item.isProcessing
                            ? "Order is Processing"
                            : "Order is delivered"}
                        </button>
                        <button
                          ...
                          className="disabled:opacity-50 mt-5 max-[415px]:mt-0 inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
                        >
                          {componentLevelLoader &&
